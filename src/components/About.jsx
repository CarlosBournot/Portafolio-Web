  ...
  return (
    <section className="mt-20" >
      ...
      <div className="lg:flex lg:flex-row-reverse lg:justify-center lg:items-center lg:mt-10">
        <div className="max-w-[150px] mx-auto flex justify-center items-center mt-10 lg:-mt-20 xl:max-w-[200px]">
          <img src="./image/codear.png" alt="avatar-1" className="w-full" />
        </div>
